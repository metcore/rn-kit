...
> = {
  ...
  primary: {
    ...
    tertiaryBorderColor: Color.base.white100,
    tertiaryFocusTextColor: Color.primary[1000],
  ...
  danger: {
    ...
    outlinePressTextColor: Color.danger[600],
    outlinePressBorderColor: Color.danger[600],
